...
export type FluentMessageId =
  ...
  | 'remove'
  | 'rollback-previous-button'
  | 'rollback-previous-confirm-confirm'
  | 'rollback-previous-confirm-message'
  | 'rollback-previous-confirm-title'
  | 'rollback-previous-no-download'
  | 'rollback-previous-not-found'
