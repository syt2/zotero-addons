import { customSourceApi, currentSource } from "../utils/configuration";
...
export function z7XpiDownloadUrls(addonInfo: AddonInfo) {
  ...
  switch (currentSource().id) {
    case "source-zotero-chinese-github":
      return [z7DownloadUrls.github, z7DownloadUrls.gitee, z7DownloadUrls.jsdeliver, z7DownloadUrls.ghProxy];
    case "source-zotero-chinese-ghproxy":
      return [z7DownloadUrls.ghProxy, z7DownloadUrls.github, z7DownloadUrls.gitee, z7DownloadUrls.jsdeliver];
    case "source-zotero-chinese-jsdelivr":
      return [z7DownloadUrls.jsdeliver, z7DownloadUrls.github, z7DownloadUrls.gitee, z7DownloadUrls.ghProxy];
    case "source-zotero-chinese-gitee":
      return [z7DownloadUrls.gitee, z7DownloadUrls.github, z7DownloadUrls.jsdeliver, z7DownloadUrls.ghProxy];
    default:
      return [z7DownloadUrls.github, z7DownloadUrls.gitee, z7DownloadUrls.jsdeliver, z7DownloadUrls.ghProxy];
  }
}
